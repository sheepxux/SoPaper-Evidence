...
Use this file when creating the public repository page, description, and first launch post.
...
- push the current tree
- set the short description
- apply suggested topics
- set the repository website if a marketplace page exists
- use the OpenClaw example set in the first screenshot or overview
- create the first release using `v0.2.0`
- publish marketplace entry and link back to GitHub
