...
Use bundled `scripts/run_evidence_pipeline.py` when the user already has source files, claims, and optional result artifacts and wants one end-to-end draft pack. Result artifacts may be structured markdown, `.csv`, `.tsv`, or `.json`.
